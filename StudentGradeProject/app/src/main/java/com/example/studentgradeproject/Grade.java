...
public class Grade {
    ...
    {
        double assignment_avg = (s_grade_Assignment1 + s_grade_Assignment2 + s_grade_Assignment3) / 3;
        double midterm_avg = s_grade_Mid_Term;
        double final_exam_avg = s_grade_Final_Term;

        // Calculating the weighted average
        double total_avg = (0.4 * assignment_avg) + (0.3 * midterm_avg) + (0.3 * final_exam_avg);
